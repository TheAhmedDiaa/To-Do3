...
export default function TasksMenu({ taskId }) {
    ...
    <div className="w-52 text-right">
      <Menu>
        ...
        >
          ...
          <MenuItem>
            <button className="group flex w-full items-center gap-2 rounded-lg px-3 py-1.5 data-focus:bg-white/10" onClick={() => handleComplete(taskId)}>
          ...
          <MenuItem>
            <button className="group flex w-full items-center gap-2 rounded-lg px-3 py-1.5 data-focus:bg-white/10" onClick={() => handleDelete(taskId)}>
